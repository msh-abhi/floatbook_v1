/*
  # Cleanup and Recreate All Reporting Functions with Filters
  ...
  1. Purpose:
    ...
    - It then RECREATES all functions with the correct, final signatures
      that accept all necessary filtering parameters.
    - This is the single source of truth for all reporting functions.
...
-- get_occupancy_report with all filters
