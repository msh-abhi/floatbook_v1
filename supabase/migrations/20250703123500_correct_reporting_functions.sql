/*
  # Corrected Advanced Reporting Functions with Filters

  1. Purpose:
    - This migration file corrects and replaces all previous reporting functions
      to ensure they have the correct parameters for advanced filtering.
    - This single file should be the source of truth for the reporting functions.
